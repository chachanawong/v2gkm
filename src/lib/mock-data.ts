import type { Admin, AuditLog, Category, Event, EventRegistration, Knowledge, Lesson, LearningPath, News, PreviewToken, Profile, User, UserProgress } from "./types";
...
export const db = { users, admins, categories, knowledge, news, profiles, events, eventRegistrations, learningPaths, lessons, userProgress, auditLogs, previewTokens };
